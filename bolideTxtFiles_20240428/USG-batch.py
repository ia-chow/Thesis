...
# File path
file_dir = 'D:\\oldE\\fireballs\\Satellite Data\\bolide-lcs\\USG-CNEOS\\bolideTxtFiles_20220513\\'
name = '2018.123.072359.txt'
file_path = file_dir+name

#Open output file
file_out = open("energy_comp.dat",'a+')
...
print(f'{name} Energy Difference: {diff:.3e} and percentage: {perc:.1f}%')
file_out.write(f"{name}, {diff:.3e}, {perc:.1f} \n")
