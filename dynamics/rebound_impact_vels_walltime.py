...
sim.add(m=4.867e24, a=0.72333, e=0.00677, inc=0.05925, omega=0.957353, Omega=1.338331, r=4.05e-5, hash = 'Venus')  # Venus, angles in radians
...
# define planets
sun, mercury, venus, earth, mars, jupiter = sim.particles
