...
# EVENT
event_path = '../usg_metsim_files/1994-02-01/usg_input_feb_1994' # event path, CHANGE THIS
...
# Run NS:
import dynesty
filename = './dynesty_saves/1994_02_01_unrestricted_heights_constant_tau_new.save'  # CHANGE THIS
