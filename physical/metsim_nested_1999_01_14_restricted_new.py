...
# EVENT
event_path = '../usg_metsim_files/1999-01-14/usg_input_jan_1999' # event path, CHANGE THIS

# CHANGE THESE
FIXED_FRAG_INDICES = []
FREE_FRAG_INDICES = [0, 1, 2, 3, 4]#, 5]#, 6, 7, 8]  # fragments with free parameters
ER_FRAG_INDICES = [1, 2, 3, 4]  # free fragments that have erosion coefficients (i.e. all free fragments excluding dust)
...
# CHANGE THIS
initial_guess = np.load('initial_guess_1999_01_14_TEST.npy')  # initial pre-saved guess
...
frag_erosion_coeffs = tuple([(0.10 * 1e-6, 10.0 * 1e-6) for entry in 
...
# Run NS:
import dynesty
filename = './dynesty_saves/1999_01_14_restricted_new.save'  # CHANGE THIS
