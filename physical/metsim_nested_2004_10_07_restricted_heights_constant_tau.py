...
# EVENT
event_path = '../usg_metsim_files/2004-10-07/usg_input_oct_2004' # event path, CHANGE THIS
...
# CHANGE THIS
initial_guess = np.load('initial_guesses/initial_guess_2004_10_07_TEST_heights.npy') # initial pre-saved guess
...
# CHANGE THIS
height_bounds = 3000.  # permissible values plus or minus the starting fragmentation height
...
# Run NS:
import dynesty
filename = './dynesty_saves/2004_10_07_restricted_heights_constant_tau.save'  # CHANGE THIS
