...
# CHANGE THIS
initial_guess = np.load('initial_guesses/initial_guess_2010_07_06_TEST_heights.npy') # initial pre-saved guess
...
# Run NS:
import dynesty
filename = './dynesty_saves/2010_07_06_unrestricted_heights_constant_tau_new.save'  # CHANGE THIS
