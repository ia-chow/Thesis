...
# EVENT
event_path = '../usg_metsim_files/2013-02-15/usg_input_feb_2013' # event path, CHANGE THIS
...
# CHANGE THIS
initial_guess = np.load('initial_guesses/initial_guess_2013_02_15_TEST_heights.npy')  # initial pre-saved guess
