...
# EVENT
event_path = '../usg_metsim_files/2016-02-06/usg_input_feb_2016' # event path, CHANGE THIS

# CHANGE THESE
FIXED_FRAG_INDICES = []
FREE_FRAG_INDICES = [0, 1, 2, 3, 4, 5]#, 6, 7, 8]  # fragments with free parameters
ER_FRAG_INDICES = [0, 1, 2, 3, 4]#, 2, 3, 4]  # free fragments that have erosion coefficients (i.e. all free fragments excluding dust)
...
# CHANGE THIS
initial_guess = np.load('initial_guesses/initial_guess_2016_02_06_TEST_heights.npy') # initial pre-saved guess
...
# CHANGE THIS
height_bounds = 700.  # permissible values plus or minus the starting fragmentation height
...
# Run NS:
import dynesty
filename = './dynesty_saves/2016_02_06_restricted_heights.save'  # CHANGE THIS
