...
# EVENT
event_path = '../usg_metsim_files/2020-12-22/usg_input_dec_2020' # event path, CHANGE THIS
...
# CHANGE THIS
initial_guess = np.load('initial_guesses/initial_guess_2020_12_22_TEST_heights.npy') # initial pre-saved guess
...
# CHANGE THIS
height_bounds = 550.  # permissible values plus or minus the starting fragmentation height
...
# Run NS:
import dynesty
filename = './dynesty_saves/2020_12_22_restricted_heights.save'  # CHANGE THIS
