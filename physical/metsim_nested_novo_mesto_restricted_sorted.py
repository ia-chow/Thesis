...
metsim_obj = MetSimObj(traj_path=event_path + '.pickle', 
                       ...
                       lc_path='../novo_mesto/ablation_modelling/light_curve_no_cneos_sorted.csv',
...
print(f'Initial guess:{lamb_func(initial_guess)}')  # DENIS' BEST FIT FOR NOVO MESTO IS ~21.4
...
# n_threads = 48
n_threads = 50
timeout = 30  # number of seconds to timeout
