...
# EVENT
event_path = '../usg_metsim_files/non_decameter/romania/usg_input_romania' # event path, CHANGE THIS
...
# CHANGE THIS
initial_guess = np.load('initial_guesses/initial_guess_romania_TEST_heights.npy') # initial pre-saved guess
...
# Run NS:
import dynesty
filename = './dynesty_saves/romania_unrestricted_heights_constant_tau.save'  # CHANGE THIS
