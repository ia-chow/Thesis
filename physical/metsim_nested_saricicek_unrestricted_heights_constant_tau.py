...
logl_scale_factor = 1.e20  # factor to scale the log likelihood by
...
# EVENT
event_path = '../usg_metsim_files/non_decameter/saricicek/usg_input_saricicek_trunc' # event path, CHANGE THIS
...
# CHANGE THIS
initial_guess = np.load('initial_guesses/initial_guess_saricicek_TEST_heights.npy') # initial pre-saved guess
...
# Run NS:
import dynesty
filename = './dynesty_saves/saricicek_unrestricted_heights_constant_tau.save'  # CHANGE THIS
